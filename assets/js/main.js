...
// Split + Zoom + Reveal
tl.to(".video-left", { xPercent: -100, ease: "power2.out" }, 0);
tl.to(".video-right", { xPercent: 100, ease: "power2.out" }, 0);

// Add zoom-in on both videos
tl.to("#videoLeft, #videoRight", { scale: 1.2, ease: "power2.out" }, 0);
